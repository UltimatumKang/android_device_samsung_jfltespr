...
# name
PRODUCT_RELEASE_NAME := SPRGS4

# device
$(call inherit-product-if-exists, device/samsung/jfltespr/full_jfltespr.mk)
...
PRODUCT_NAME := ukg_jfltespr
PRODUCT_MODEL := Samsung Galaxy S 4
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.jfltespr.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="jfltespr-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/jfltespr:4.2.2/JDQ39/573038:user/release-keys"
